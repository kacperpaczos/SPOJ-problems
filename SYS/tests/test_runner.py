#!/usr/bin/env python3
"""
Test runner utility for executing SYS solutions.
...
class SolutionRunner:
    ...
    def __init__(self, solutions_dir: str = "solutions"):
        ...
        self.solutions = {
            'python': os.path.join(self.solutions_dir, 'sys.py'),
            'java': os.path.join(self.solutions_dir, 'SYS.java'),
            'cpp': os.path.join(self.solutions_dir, 'sys.cpp')
        }
    ...
    def _run_cpp(self, file_path: str, input_data: str, timeout: int) -> Tuple[str, str, int]:
        ...
        exe_path = os.path.join(self.solutions_dir, 'sys_exe')
